var PHYSX = (function () {
  ...
  return function (PHYSX) {
    ...
    var wasmMemory
    var wasmTable = new WebAssembly.Table({ initial: 4386, maximum: 4386 + 0, element: 'anyfunc' })
    var ABORT = false
    var EXITSTATUS = 0
    ...
    var STACK_BASE = 5445616,
      STACK_MAX = 202736,
      DYNAMIC_BASE = 5445616,
      DYNAMICTOP_PTR = 202576
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = PHYSX
